...
def main():
    ...
    parser.add_argument("--bank", nargs='+', choices=banks_list, default=banks_list, help="Select specific command banks")
    parser.add_argument("--subbank", nargs='+', choices=["general"], default=["general"], help="Select specific command subbanks")
    parser.add_argument("--category", nargs='+', choices=categories_list, default='none', help="Select sets of banks based on their implications")
    parser.add_argument("--difficulty", nargs='+', choices=["easy", "medium", "hard"], default=["easy", "medium", "hard"], help="Choose difficulty levels")
