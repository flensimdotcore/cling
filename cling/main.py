...
def main():
    ...
    categories_list = [file.stem for file in Path(
        categories_prefix).glob('*.yaml')]
    parser = argparse.ArgumentParser(
        prog="cling", description="CLI commands training utility")
    parser.add_argument(
        "--bank",
        nargs='+',
        choices=banks_list,
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "ru"],
        default="en",
        help="Choose an interface language")
    parser.add_argument(
        "--repeat",
        type=int,
        default=5,
        help="Amount of questions in session")
